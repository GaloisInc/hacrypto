...
3.  The file SigGen15_186-3.txt contains values for RSA PKCS#1 Ver 1.5 signature geenration with the additional value d added to the file for testing purposes.
