 ...
 * Mutable parameters
 ******************************************************************/
#define KINDI_KEM_N 512
#define KINDI_KEM_LAMBDA 256
#define KINDI_KEM_SHAKEMODE 256

#define KINDI_KEM_LOGQ 13
#define KINDI_KEM_L 3
#define KINDI_KEM_T 1
#define KINDI_KEM_LOG2RSEC 1
#define KINDI_KEM_S1SIZE (512/8)
...
#define KINDI_KEM_CIPHERBYTES (KINDI_KEM_NUMBER_CIPHERPOLY*KINDI_KEM_CIPHER_POLYBYTES + KINDI_KEM_HASHSIZE)
