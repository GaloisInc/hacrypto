...
const uint16_t _16xmontsq[16] __attribute__((aligned(32))) = {MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ, MONTSQ};
const uint32_t _mask11[8] __attribute__((aligned(32))) = {0x11111111,0x11111111,0x11111111,0x11111111,0x11111111,0x11111111,0x11111111,0x11111111};
const uint32_t _mask0f[8] __attribute__((aligned(32))) = {0x0f0f0f0f,0x0f0f0f0f,0x0f0f0f0f,0x0f0f0f0f,0x0f0f0f0f,0x0f0f0f0f,0x0f0f0f0f,0x0f0f0f0f};
const uint16_t _lowdword[16] __attribute__((aligned(32))) = {0xffff, 0x0, 0xffff, 0x0, 0xffff, 0x0, 0xffff, 0x0, 0xffff, 0x0, 0xffff, 0x0, 0xffff, 0x0, 0xffff, 0x0};
