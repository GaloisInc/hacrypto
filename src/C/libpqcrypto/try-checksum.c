/*
 * try-checksum.c version 20180223
 * D. J. Bernstein
...
int main()
{
  ...
  for (i = 0;i < 32;++i) {
    putchar("0123456789abcdef"[15 & (checksum_state[i] >> 4)]);
    putchar("0123456789abcdef"[15 & checksum_state[i]]);
  }

  printf(" %lld %lld\n",checksumcycles,cyclespersecond);
  return 0;
}
