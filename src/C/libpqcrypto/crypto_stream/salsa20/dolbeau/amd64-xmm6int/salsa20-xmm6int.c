...
void crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_encrypt_bytes(crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_ctx *x_, const u8 *m_,u8 *c_,u32 bytes)
{
  int i;
  u32* x = (u32*)&x_->input;
  u8* out = c_;
...
void crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_init(void)
{
  return;
}
...
void crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_keysetup(crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_ctx *x,const u8 *k,u32 kbits,u32 ivbits)
{
...
/* This initializes in SIMD format */
void crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_ivsetup(crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_ctx *x,const u8 *iv)
{
...
void crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_decrypt_bytes(crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_ctx *x,const u8 *c,u8 *m,u32 bytes)
{
  crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_encrypt_bytes(x,c,m,bytes);
}

void crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_keystream_bytes(crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_ctx *x,u8 *stream,u32 bytes)
{
  u32 i;
  for (i = 0;i < bytes;++i) stream[i] = 0;
  crypto_stream_salsa20_dolbeau_amd64_xmm6int_ECRYPT_encrypt_bytes(x,stream,stream,bytes);
}
