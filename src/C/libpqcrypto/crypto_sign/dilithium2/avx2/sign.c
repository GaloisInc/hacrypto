                ...
                const unsigned char *sk) 
{
  ...
  memcpy(sm + CRYPTO_BYTES - CRHBYTES,tr,sizeof tr);
                     ...
                     const unsigned char *pk)
{
  ...
  *mlen = smlen - CRYPTO_BYTES;
  ...
  memmove(m + CRYPTO_BYTES - CRYPTO_PUBLICKEYBYTES,pk,CRYPTO_PUBLICKEYBYTES);
  
  memmove(m + CRYPTO_BYTES,sm + CRYPTO_BYTES,*mlen);
