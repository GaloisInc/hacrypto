...
#define mpkc_pub_map_gf256_n_m   mpkc_pub_map_gf256_n_m_avx2

#else

#define mpkc_pub_map_gf256       _mpkc_pub_map_gf256
#define mpkc_pub_map_gf256_n_m   _mpkc_pub_map_gf256_n_m
...
static inline
void _mpkc_pub_map_gf256_n_m( uint8_t * z , const uint8_t * pk_mat , const uint8_t * w , unsigned n, unsigned m)
{
