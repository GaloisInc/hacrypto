...
#define gf16v_split       gf16v_split_sse
...
#define gf16v_split       _gf16v_split
#define gf16mat_gauss_elim _gf16mat_gauss_elim_sse
...
static inline
void _gf16v_split( uint8_t * z , const uint8_t * x , unsigned n )
{
