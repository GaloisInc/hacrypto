...
#include "apiorig.h"
#include <stdio.h>
extern const int32_t bitrev[PARAM_N];
extern const poly omega;
extern const poly omegainv;
extern const poly psi;
extern const poly psiinv;
