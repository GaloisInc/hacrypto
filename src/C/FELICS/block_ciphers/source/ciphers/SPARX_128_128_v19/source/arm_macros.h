...
#define L_(b0, b1, b2, b3, b4, b5, b6, b7, mask) \
...
#define ENC_ADD_WHITENING_KEY_(b0, b1, b2, b3, b4, b5, b6, b7, rk) \
    ldrh rk, [r1]                                             \n\t \
    eor b0, b0, rk                                            \n\t \
                                                                   \
    ldrh rk, [r1, CV2]                                        \n\t \
...
#define DEC_ADD_WHITENING_KEY_(b0, b1, b2, b3, b4, b5, b6, b7, rk) \
    ldrh rk, [r1]                                             \n\t \
    eor b0, b0, rk                                            \n\t \
                                                                   \
    ldrh rk, [r1, CV2]                                        \n\t \
...
#define L(b0, b1, b2, b3, b4, b5, b6, b7, mask) \
    STR(L_(b0, b1, b2, b3, b4, b5, b6, b7, mask))


#define ENC_ADD_WHITENING_KEY(b0, b1, b2, b3, b4, b5, b6, b7, rk) \
    STR(ENC_ADD_WHITENING_KEY_(b0, b1, b2, b3, b4, b5, b6, b7, rk))

#define DEC_ADD_WHITENING_KEY(b0, b1, b2, b3, b4, b5, b6, b7, rk) \
    STR(DEC_ADD_WHITENING_KEY_(b0, b1, b2, b3, b4, b5, b6, b7, rk))
