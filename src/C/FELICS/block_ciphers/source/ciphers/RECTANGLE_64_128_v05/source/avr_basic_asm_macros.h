...
#define store_subkey_first_(k0, k1, k4, k5, k8, k9, k12, k13)	\
	st	y+,	k5			\n\t	\
	st	y+,	k13			\n\t	\
	st	y+,	k0			\n\t	\
	st	y+,	k4			\n\t	\
...
#define store_subkey_first(k0, k1, k4, k5, k8, k9, k12, k13)	\
	STR(store_subkey_first_(k0, k1, k4, k5, k8, k9, k12, k13))

/* store sub keys 					*/
#define store_subkey_(k0, k1, k4, k8, k9, k12)		\
	st	y+,	k0			\n\t	\
	st	y+,	k4			\n\t	\
	st	y+,	k8			\n\t	\
	st	y+,	k12			\n\t	\
...
#define store_subkey(k0, k1, k4, k8, k9, k12)		\
	STR(store_subkey_(k0, k1, k4, k8, k9, k12))
...
#define dec_keyxor_ram_(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
	eor	s1,	kt1			\n\t	\
	eor	s5,	kt0			\n\t	\
	ld	k,	-z			\n\t	\
	eor	s6,	k			\n\t	\
...
#define dec_keyxor_flash_(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
	eor	s1,	kt1			\n\t	\
	eor	s5,	kt0			\n\t	\
	lpm	kt0,	z+			\n\t	\
	eor	s3,	kt0			\n\t	\
...
/* dec key xor, it's different between scenario1 and scenario2 */
	...
	#define dec_keyxor(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
		STR(dec_keyxor_flash_(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k))
#else
	#define dec_keyxor(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
		STR(dec_keyxor_ram_(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k))
#endif
