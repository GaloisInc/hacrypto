...
void Decrypt(uint8_t *block, uint8_t *roundKeys)
{
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 2]);
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 22]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 20]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 18]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 16]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 14]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 12]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 10]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 8]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 6]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 4]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i + 2]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
	}
	...
	for(i = 0; i < 2; i++)
	{
		Block[i] = Block[i] ^ READ_ROUND_CONSTANT_DOUBLE_WORD(RoundConstants[i]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i + 4]);
		Block[i] = Block[i] ^ READ_ROUND_KEY_DOUBLE_WORD(RoundKeys[i]);
	}
}
