...
//const uint8_t expectedCiphertext[BLOCK_SIZE] = {0X2D,0X96,0XE3,0X54,0XE8,0XB1,0X08,0X74};
...
const uint8_t expectedCiphertext[BLOCK_SIZE] = {0X99,0X45,0XAA,0X34,0XAE,0X3D,0X01,0X12};
