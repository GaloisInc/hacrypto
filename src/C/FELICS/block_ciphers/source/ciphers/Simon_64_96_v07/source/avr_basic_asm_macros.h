...
/* Invert the most significant input word bytes and add the Z_XOR_252 constant */
...
#define SIMON_KS_ROUND(x3, x2, x1, x0, y3, y2, y1, y0, z3, z2, z1, z0, q3, q2, q1, q0) \
  MOV(q3, q2, q1, q0, z3, z2, z1, z0)                                   \
  MOV(z3, z2, z1, z0, y3, y2, y1, y0)                                   \
  MOV(y3, y2, y1, y0, x3, x2, x1, x0)                                   \
  RCS3(x3, x2, x1, x0)                                                  \
  XOR(q3, q2, q1, q0, x3, x2, x1, x0)                                   \
  RCS1(x3, x2, x1, x0)                                                  \
  XOR(q3, q2, q1, q0, x3, x2, x1, x0)                                   \
  SIMON_ADD_CONST(q3, q2, q1, q0, x0)					\
  MOV(x3, x2, x1, x0, q3, q2, q1, q0)                     
