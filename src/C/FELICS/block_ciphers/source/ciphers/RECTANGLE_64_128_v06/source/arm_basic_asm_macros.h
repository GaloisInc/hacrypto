...
#define shift_row_(k0, k1, k2, k3, tk0, tk1, tk2, tk3)	\
	bfi	tk0,	k0,ZERO,EIGHT		\n\t	\
	bfi	tk1,	k1,ZERO,EIGHT		\n\t	\
	bfi	tk2,	k2,ZERO,EIGHT		\n\t	\
	bfi	tk3,	k3,ZERO,EIGHT		\n\t	\
	eor	k0,	tk1,	tk0,ror TWENTY_FORE\n\t	\
	mov	k1,	tk2			\n\t	\
	eor	k2,	tk3,	tk2,ror SIXTEEN	\n\t	\
	mov	k3,	tk0			\n\t

#define shift_row(k0, k1, k2, k3, tk0, tk1, tk2, tk3)	\
	STR(shift_row_(k0, k1, k2, k3, tk0, tk1, tk2, tk3))
...
#define key_schedule(k0, k1, k2, k3, t0, t1, tk0, tk1, tk2, tk3, rc_p)	\
	...
	shift_row(k0, k1, k2, k3, tk0, tk1, tk2, tk3)	\
