...
#define EKS_STORE_ROUND_KEYS_(k0, k1, k2, k3, k4, k5, temp) \
    eor temp, k0, k1, lsl CV16                         \n\t \
    stm r1!, {temp}                                    \n\t \
                                                            \
    eor temp, k2, k3, lsl CV16                         \n\t \
    stm r1!, {temp}                                    \n\t \
                                                            \
    eor temp, k4, k5, lsl CV16                         \n\t \
    stm r1!, {temp}                                    \n\t
...
// same execution time and number of registers (except for the mask) for 32-bit and 16-bit operation
#define L_(b0, b1, b2, b3, t0, t1, mask) \
    orr t0, b0, b1, lsl CV16        \n\t \
    orr t1, b2, b3, lsl CV16        \n\t \
                                         \
    eor t1, t1, t0                  \n\t \
    eor t1, t1, t0, ror CV8         \n\t \
    eor t1, t1, t0, ror CV24        \n\t \
                                         \
    and b2, mask, t1                \n\t \
    and b3, mask, t1, lsr CV16      \n\t


#define ENC_ADD_WHITENING_KEY_(b0, b1, b2, b3, rk, mask) \
    ldm r1!, {rk}                                   \n\t \
                                                         \
    eor b0, b0, rk                                  \n\t \
    and b0, b0, mask                                \n\t \
...
#define DEC_ADD_WHITENING_KEY_(b0, b1, b2, b3, rk, mask) \
    ldmdb r1!, {rk}                                 \n\t \
                                                         \
    eor b2, b2, rk                                  \n\t \
    and b2, b2, mask                                \n\t \
...
#define EKS_STORE_ROUND_KEYS(k0, k1, k2, k3, k4, k5, temp) \
    STR(EKS_STORE_ROUND_KEYS_(k0, k1, k2, k3, k4, k5, temp))
...
#define L(b0, b1, b2, b3, t0, t1, mask) \
    STR(L_(b0, b1, b2, b3, t0, t1, mask))
...
#define ENC_ADD_WHITENING_KEY(bo, b1, b2, b3, rk, mask) \
    STR(ENC_ADD_WHITENING_KEY_(bo, b1, b2, b3, rk, mask))

#define DEC_ADD_WHITENING_KEY(bo, b1, b2, b3, rk, mask) \
    STR(DEC_ADD_WHITENING_KEY_(bo, b1, b2, b3, rk, mask))
