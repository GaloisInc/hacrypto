...
#define ROUND_TABLE_WORD ROM_DATA_WORD
#define READ_ROUND_TABLE_WORD READ_ROM_DATA_WORD

#define INVERSE_ROUND_TABLE_WORD ROM_DATA_WORD
#define READ_INVERSE_ROUND_TABLE_WORD READ_ROM_DATA_WORD
