...
#define KEY_SIZE 12 /* Replace with the cipher key size in bytes */
#define ROUND_KEYS_SIZE 12 /* Replace with the cipher round keys size in bytes */

#define NUMBER_OF_ROUNDS 0 /* Replace with the cipher number of rounds */
