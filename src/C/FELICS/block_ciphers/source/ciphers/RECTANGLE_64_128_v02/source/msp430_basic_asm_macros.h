...
/* key xor---- 						*/
#define keyxor_(s0, s1, s2, s3, t0, x)			\
	mov	@x+,	t0			\n\t	\
	xor	t0,	s0			\n\t	\
	mov	@x+,	t0			\n\t	\
	xor	t0,	s1			\n\t	\
...
#define keyxor(s0, s1, s2, s3, t0, x)			\
	STR(keyxor_(s0, s1, s2, s3, t0, x))

/* one round of encryption			 	*/
#define enc_round(s0, s1, s2, s3, x, t0, t1)		\
	keyxor(s0, s1, s2, s3, t0, x)			\
...
/* dec key xor----  					*/
#define dec_keyxor_(s0, s1, s2, s3, t0, x)		\
	mov	0(x),	t0			\n\t	\
	xor	t0,	s0			\n\t	\
	mov	2(x),	t0			\n\t	\
	xor	t0,	s1			\n\t	\
...
#define dec_keyxor(s0, s1, s2, s3, t0, x)		\
	STR(dec_keyxor_(s0, s1, s2, s3, t0, x))

/* one round of decryption 				*/
#define dec_round(s0, s1, s2, s3, x, t0, t1)		\
	dec_keyxor(s0, s1, s2, s3, t0, x)		\
