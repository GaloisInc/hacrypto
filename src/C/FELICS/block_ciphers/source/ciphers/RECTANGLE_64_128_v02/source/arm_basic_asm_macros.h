...
/* ---------------------------------------------------- */
/* Key Schedule Start 					*/
#define temp_key_(k0, k1, k2, k3, tk0, tk1, tk2, tk3)	\
	mov	tk0,	k0			\n\t	\
	mov	tk1,	k1			\n\t	\
	mov	tk2,	k2			\n\t	\
	mov	tk3,	k3			\n\t

#define temp_key(k0, k1, k2, k3, tk0, tk1, tk2, tk3)	\
	STR(temp_key_(k0, k1, k2, k3, tk0, tk1, tk2, tk3))

/* recover the higher 3 bytes				*/
#define recover_key_(k0, k1, k2, k3, tk0, tk1, tk2, tk3)\
	ror	tk0,	tk0,	EIGHT		\n\t	\
	bfi	k0,	tk0,EIGHT,TWENTY_FORE	\n\t	\
	ror	tk1,	tk1,	EIGHT		\n\t	\
	bfi	k1,	tk1,EIGHT,TWENTY_FORE	\n\t	\
	ror	tk2,	tk2,	EIGHT		\n\t	\
	bfi	k2,	tk2,EIGHT,TWENTY_FORE	\n\t	\
	ror	tk3,	tk3,	EIGHT		\n\t	\
	bfi	k3,	tk3,EIGHT,TWENTY_FORE	\n\t

#define recover_key(k0, k1, k2, k3, tk0, tk1, tk2, tk3)	\
	STR(recover_key_(k0, k1, k2, k3, tk0, tk1, tk2, tk3))

/* Only the lower word(16 bits) are needed. 		*/
#define store_subkey_(k0, k1, k2, k3, t0, t1, p)	\
	mov	t0,	k0			\n\t	\
	bfi	t0,	k1,SIXTEEN,SIXTEEN	\n\t	\
	mov	t1,	k2			\n\t	\
	bfi	t1,	k3,SIXTEEN,SIXTEEN	\n\t	\
	stm	p!,	{t0,t1}			\n\t
	

#define store_subkey(k0, k1, k2, k3, t0, t1, p)		\
	STR(store_subkey_(k0, k1, k2, k3, t0, t1, p))

/* key schedule shift row				*/
#define key_sche_shift_row_(k0, k1, k2, k3, t0)		\
	mov	t0,	k0			\n\t	\
	eor	k0,	k1,	k0,ror TWENTY_FORE\n\t	\
	mov	k1,	k2			\n\t	\
	eor	k2,	k3,	k2,ror SIXTEEN	\n\t	\
	mov	k3,	t0			\n\t

#define key_sche_shift_row(k0, k1, k2, k3, t0)		\
	STR(key_sche_shift_row_(k0, k1, k2, k3, t0))
...
/* key schedule						*/
#define key_schedule(k0, k1, k2, k3, t0, t1, tk0, tk1, tk2, tk3, rc_p)	\
	temp_key(k0, k1, k2, k3, tk0, tk1, tk2, tk3)	\
	sbox(k0, k1, k2, k3, t0, t1)			\
	recover_key(k0, k1, k2, k3, tk0, tk1, tk2, tk3)	\
	key_sche_shift_row(k0, k1, k2, k3, t0)		\
