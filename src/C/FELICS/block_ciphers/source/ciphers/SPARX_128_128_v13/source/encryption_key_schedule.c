...
void RunEncryptionKeySchedule(uint8_t *key, uint8_t *roundKeys)
{
    asm volatile(
        ...
        */
        ...
        EKS_STORE_ROUND_KEYS(r5, r2, r3, r4)
        "add r0, r0, #1" "\n\t"


        EKS_ROUND_KEYS(r5, r2, r3, r4, r6, r7, r8, r9, r0)
        EKS_STORE_ROUND_KEYS(r4, r5, r2, r3)
        "add r0, r0, #1" "\n\t"


        EKS_ROUND_KEYS(r4, r5, r2, r3, r6, r7, r8, r9, r0)
        EKS_STORE_ROUND_KEYS(r3, r4, r5, r2)
        "add r0, r0, #1" "\n\t"
...
void /*__attribute__((naked))*/ RunEncryptionKeySchedule(uint8_t *key, uint8_t *roundKeys)
{
    asm volatile(
        ...
        */
        ...
        /* store round keys */
        EKS_STORE_ROUND_KEYS(r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26)
        ...
        EKS_STORE_ROUND_KEYS(r23, r24, r25, r26, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22)
        "inc r27" "\n\t"


        EKS_ROUND_KEYS(r23, r24, r25, r26, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r27)
        EKS_STORE_ROUND_KEYS(r19, r20, r21, r22, r23, r24, r25, r26, r11, r12, r13, r14, r15, r16, r17, r18)
        "inc r27" "\n\t"


        EKS_ROUND_KEYS(r19, r20, r21, r22, r23, r24, r25, r26, r11, r12, r13, r14, r15, r16, r17, r18, r27)
        EKS_STORE_ROUND_KEYS(r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r11, r12, r13, r14)
        "inc r27" "\n\t"
...
void /*__attribute__((naked))*/ RunEncryptionKeySchedule(uint8_t *key, uint8_t *roundKeys)
{
    asm volatile(
        ...
        */
        ...
        /* store round keys */
        EKS_STORE_ROUND_KEYS(r6, r7, r8, r9, r10, r11, r12, r13)
        ...
        EKS_STORE_ROUND_KEYS(r12, r13, r6, r7, r8, r9, r10, r11)
        "inc r15" "\n\t"


        EKS_ROUND_KEYS(r12, r13, r6, r7, r8, r9, r10, r11, r15)
        EKS_STORE_ROUND_KEYS(r10, r11, r12, r13, r6, r7, r8, r9)
        "inc r15" "\n\t"


        EKS_ROUND_KEYS(r10, r11, r12, r13, r6, r7, r8, r9, r15)
        EKS_STORE_ROUND_KEYS(r8, r9, r10, r11, r12, r13, r6, r7)
        "inc r15" "\n\t"
