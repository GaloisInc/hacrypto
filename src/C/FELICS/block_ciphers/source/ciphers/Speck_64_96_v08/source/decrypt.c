...
void __attribute__((naked)) Decrypt(uint8_t *block, uint8_t *roundKeys)
{
  asm (
    ...
    SPECK_DEC_ROUND3(r12, r11, r10, r9, r14, r8)

    "dec r13"          "\n\t"
    "jne loop_begin"   "\n\t"

    SPECK_DEC_ROUND2(r12, r11, r10, r9, r14, r8)
...
void __attribute__((naked)) Decrypt(uint8_t *block, uint8_t *roundKeys)
{
  asm (
    ...
    SPECK_DEC_ROUND3(r21, r20, r19, r18, r16, r15, r14, r13, r25, r24, r23, r22)
    ...
    SPECK_DEC_ROUND2(r21, r20, r19, r18, r16, r15, r14, r13, r25, r24, r23, r22)
