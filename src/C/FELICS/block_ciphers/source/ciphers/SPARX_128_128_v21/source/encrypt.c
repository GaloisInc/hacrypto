...
void Encrypt(uint8_t *block, uint8_t *roundKeys)
{
    asm volatile(
        ...
        */
        ...
        ENC_ADD_ROUND_KEY(r2, r3, r10, r11)
        ENC_A(r2, r3, r10, r11)
        ...
        ENC_ADD_ROUND_KEY(r4, r5, r10, r11)
        ENC_A(r4, r5, r10, r11)
        ...
        ENC_ADD_ROUND_KEY(r6, r7, r10, r11)
        ENC_A(r6, r7, r10, r11)
        ...
        ENC_ADD_ROUND_KEY(r8, r9, r10, r11)
        ENC_A(r8, r9, r10, r11)
        ...
        /* post whitening */
        ENC_ADD_WHITENING_KEY(r2, r3, r4, r5, r6, r7, r8, r9, r10, r11)
...
*/
    ...
    asm volatile(
        ...
        */
        ...
        /* linear layer */
        ENC_L(r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r7)
