...
/* store sub keys the first round			*/
#define store_subkey_first_(k0, k1, k2, k3, k4, k5, k6, k7)	\
	st	y+,	k3			\n\t	\
	st	y+,	k5			\n\t	\
	st	y+,	k0			\n\t	\
	st	y+,	k1			\n\t	\
...
#define store_subkey_first(k0, k1, k2, k3, k4, k5, k6, k7)	\
	STR(store_subkey_first_(k0, k1, k2, k3, k4, k5, k6, k7))
	
/* store sub keys					*/
#define store_subkey_(k0, k1, k2, k4, k6, k7)		\
	st	y+,	k0			\n\t	\
	st	y+,	k1			\n\t	\
	st	y+,	k2			\n\t	\
	st	y+,	k4			\n\t	\
...
#define store_subkey(k0, k1, k2, k4, k6, k7)		\
	STR(store_subkey_(k0, k1, k2, k4, k6, k7))
...
#define rotate16_left_row2_(s4, s5, t0)			\
	swap	s4				\n\t	\
	swap	s5				\n\t	\
	mov	t0,	s4			\n\t	\
	eor	t0,	s5			\n\t	\
...
#define rotate16_left_row2(s4, s5, t0)			\
	STR(rotate16_left_row2_(s4, s5, t0))
	
/* rotate shift left 13 bits == rotate shift right 3 bits */
#define rotate16_left_row3_(s6, s7, t0, zero)		\
	swap	s6				\n\t	\
	swap	s7				\n\t	\
	mov	t0,	s6			\n\t	\
	eor	t0,	s7			\n\t	\
...
#define rotate16_left_row3(s6, s7, t0, zero)		\
	STR(rotate16_left_row3_(s6, s7, t0, zero))
...
#define keyxor_ram_(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k)\
	eor	s3,	kt0			\n\t	\
	eor	s5,	kt1			\n\t	\
	ld	k,	z+			\n\t	\
	eor	s0,	k			\n\t	\
...
#define keyxor_flash_(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k)\
	eor	s3,	kt0			\n\t	\
	eor	s5,	kt1			\n\t	\
	lpm	k,	z+			\n\t	\
	eor	s0,	k			\n\t	\
...
/* key xor, it's different between scenario1 and scenario2 */
	...
	#define keyxor(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
		STR(keyxor_flash_(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k))
#else
	#define keyxor(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
		STR(keyxor_ram_(kt0, kt1, s0, s1, s2, s3, s4, s5, s6, s7, k))
#endif
...
#define enc_round(s0, s1, s2, s3, s4, s5, s6, s7, t0, t1, t2, t3, zero)	\
	...
	rotate16_left_row2(s4, s5, t0)					\
	rotate16_left_row3(s6, s7, t0, zero)
/* ENCRYPTION END 					*/
/* ---------------------------------------------------- */
...
#define rotate16_right_row2_(s4, s5, t0)		\
	swap	s4				\n\t	\
	swap	s5				\n\t	\
	mov	t0,	s4			\n\t	\
	eor	t0,	s5			\n\t	\
...
#define rotate16_right_row2(s4, s5, t0)			\
	STR(rotate16_right_row2_(s4, s5, t0))
...
#define dec_keyxor_ram_(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
	eor	s5,	k5			\n\t	\
	eor	s0,	k0			\n\t	\
	eor	s1,	k1			\n\t	\
	eor	s2,	k2			\n\t	\
...
#define dec_keyxor_flash_(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k)\
	eor	s5,	k5			\n\t	\
	eor	s0,	k0			\n\t	\
	eor	s1,	k1			\n\t	\
	eor	s2,	k2			\n\t	\
...
/* dec key xor, it's different between scenario1 and scenario2 */
	...
	#define dec_keyxor(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
		STR(dec_keyxor_flash_(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k))
#else
	#define dec_keyxor(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
		STR(dec_keyxor_ram_(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k))
#endif

/* dec key xor last round 				*/
#define dec_keyxor_last_ram_(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
	eor	s5,	k5			\n\t	\
	eor	s0,	k0			\n\t	\
	eor	s1,	k1			\n\t	\
	eor	s2,	k2			\n\t	\
...
/* dec key xor last round 				*/
#define dec_keyxor_last_flash_(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k)\
	eor	s5,	k5			\n\t	\
	eor	s0,	k0			\n\t	\
	eor	s1,	k1			\n\t	\
	eor	s2,	k2			\n\t	\
...
/* dec key xor last round */
	...
	#define dec_keyxor_last(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
		STR(dec_keyxor_last_flash_(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k))
#else
	#define dec_keyxor_last(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k)	\
		STR(dec_keyxor_last_ram_(k5, k0, k1, k2, k4, k6, k7, s0, s1, s2, s3, s4, s5, s6, s7, k))
#endif

/* one round of decryption 					*/
#define dec_round(s0, s1, s2, s3, s4, s5, s6, s7, t0, t1, zero)	\
	rotate16_right_row1(s2, s3)				\
	rotate16_right_row2(s4, s5, t0)				\
