 ...
 *
 */
extern SBOX_BYTE sbox[16];
extern SBOX_BYTE MixColMatrix[4][4];
extern INVERSE_SBOX_BYTE invSbox[16];
extern INVERSE_SBOX_BYTE invMixColMatrix[4][4];
extern ROUND_CONSTANT_BYTE RC[48];
