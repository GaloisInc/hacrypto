...
void __attribute__((naked)) Decrypt(uint8_t *block, uint8_t *roundKeys)
{
  asm (
    ...
    SIMON_ENC_ROUND2_BASE(r10, r9, r12, r11, r14, r8, r7, r6, r5, r4)

    /* Jump back to the beginning of the previous key word */
    "sub #8, r14"      "\n\t"

    SIMON_ENC_ROUND2_BASE(r12, r11, r10, r9, r14, r8, r7, r6, r5, r4)
...
void __attribute__((naked)) Decrypt(uint8_t *block, uint8_t *roundKeys)
{
  asm (
    ...
    SIMON_ENC_ROUND2(r15, r14, r13, r12, r21, r20, r19, r18, r25, r24, r23, r22, r11, r10, r9, r8)
    LOAD_KEY_DEC(r25, r24, r23, r22)
    SIMON_ENC_ROUND2(r21, r20, r19, r18, r15, r14, r13, r12, r25, r24, r23, r22, r11, r10, r9, r8)
...
void Decrypt(uint8_t *block, uint8_t *roundKeys)
{
  ...
  for (i = NUMBER_OF_ROUNDS/2 - 1; i >= 0; i--) {
    x = x ^ ( rot32l1(y) & rot32l8(y) ) ^ ( rot32l1(rot32l1(y)) ) ^ READ_ROUND_KEY_DOUBLE_WORD(rk[i*2+1]);
    y = y ^ ( rot32l1(x) & rot32l8(x) ) ^ ( rot32l1(rot32l1(x)) ) ^ READ_ROUND_KEY_DOUBLE_WORD(rk[i*2]);
  }
