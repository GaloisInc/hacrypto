...
extern const uint8_t expectedIV[IV_SIZE];
extern const uint8_t expectedPlaintext[TEST_STREAM_SIZE];
extern const uint8_t expectedCiphertext[TEST_STREAM_SIZE];
