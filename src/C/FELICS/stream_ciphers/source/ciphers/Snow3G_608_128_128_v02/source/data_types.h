 ...
 */
	...
	/* Architecture = PC ; Scenario = 0 (cipher operation) */
		...
		#define MULALPHA_DOUBLE_WORD ROM_DATA_DOUBLE_WORD
		#define DIVALPHA_DOUBLE_WORD ROM_DATA_DOUBLE_WORD
		#define S_T_DOUBLE_WORD ROM_DATA_DOUBLE_WORD
	#endif
	...
	#if defined(SCENARIO) && (SCENARIO_0 == SCENARIO)
		#define SR_BYTE ROM_DATA_BYTE
		#define SQ_BYTE ROM_DATA_BYTE
		#define MULALPHA_DOUBLE_WORD ROM_DATA_DOUBLE_WORD
		#define DIVALPHA_DOUBLE_WORD ROM_DATA_DOUBLE_WORD
		#define S_T_DOUBLE_WORD ROM_DATA_DOUBLE_WORD
	#endif
