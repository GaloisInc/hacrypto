...
uint32_t S1(uint32_t w)
{
	...
	return READ_ROM_DATA_DOUBLE_WORD(S1_T0[w0]) ^ READ_ROM_DATA_DOUBLE_WORD(S1_T1[w1]) ^
	       READ_ROM_DATA_DOUBLE_WORD(S1_T2[w2]) ^ READ_ROM_DATA_DOUBLE_WORD(S1_T3[w3]);
}
...
uint32_t S2(uint32_t w)
{
	...
	return READ_ROM_DATA_DOUBLE_WORD(S2_T0[w0]) ^ READ_ROM_DATA_DOUBLE_WORD(S2_T1[w1]) ^
	       READ_ROM_DATA_DOUBLE_WORD(S2_T2[w2]) ^ READ_ROM_DATA_DOUBLE_WORD(S2_T3[w3]);
}
