...
STATE_SIZE_COLUMN_INDEX = 1
KEY_SIZE_COLUMN_INDEX = 2
IV_SIZE_COLUMN_INDEX = 3

IMPLEMENTATION_VERSION_COLUMN_INDEX = 4
IMPLEMENTATION_TYPE_COLUMN_INDEX = 5
IMPLEMENTATION_COMPILER_OPTIONS_COLUMN_INDEX = 6

CODE_SIZE_S_COLUMN_INDEX = 7
CODE_SIZE_E_COLUMN_INDEX = 8
CODE_SIZE_TOTAL_COLUMN_INDEX = 9

RAM_STACK_S_COLUMN_INDEX = 10
RAM_STACK_E_COLUMN_INDEX = 11

RAM_DATA_S_COLUMN_INDEX = 12
RAM_DATA_E_COLUMN_INDEX = 13
RAM_DATA_COMMON_COLUMN_INDEX = 14
RAM_DATA_TOTAL_COLUMN_INDEX = 15

EXECUTION_TIME_S_COLUMN_INDEX = 16
EXECUTION_TIME_E_COLUMN_INDEX = 17
...
MEDIAWIKI_CIPHER_NAME_FORMAT = '[[Lightweight_Stream_Ciphers#{}|{}]]'
