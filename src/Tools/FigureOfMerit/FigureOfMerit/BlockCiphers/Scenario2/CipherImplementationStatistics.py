...
class CipherImplementationStatistics:
    def __init__(self, name, block_size, key_size, implementation_version, position=0):
        """
        ...
        self.small_code_size_and_ram_table_entries = 0
        self.best_execution_time_table_entries = 0
