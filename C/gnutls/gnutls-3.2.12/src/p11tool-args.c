 ...
 */
static char const p11tool_opt_strs[3748] =
/*     0 */ "p11tool 3.2.12\n"
            "Copyright (C) 2000-2014 Free Software Foundation, and others, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
...
/*  1212 */ "List all available objects in a token\0"
/*  1250 */ "LIST_ALL\0"
/*  1259 */ "list-all\0"
/*  1268 */ "List all available certificates in a token\0"
/*  1311 */ "LIST_ALL_CERTS\0"
/*  1326 */ "list-all-certs\0"
/*  1341 */ "List all certificates that have an associated private key\0"
/*  1399 */ "LIST_CERTS\0"
/*  1410 */ "list-certs\0"
/*  1421 */ "List all available private keys in a token\0"
/*  1464 */ "LIST_ALL_PRIVKEYS\0"
/*  1482 */ "list-all-privkeys\0"
/*  1500 */ "an alias for the 'list-all-privkeys' option\0"
/*  1544 */ "list-privkeys\0"
/*  1558 */ "list-keys\0"
/*  1568 */ "List all available certificates marked as trusted\0"
/*  1618 */ "LIST_ALL_TRUSTED\0"
/*  1635 */ "list-all-trusted\0"
/*  1652 */ "Initializes a PKCS #11 token\0"
/*  1681 */ "INITIALIZE\0"
/*  1692 */ "initialize\0"
/*  1703 */ "Writes the loaded objects to a PKCS #11 token\0"
/*  1749 */ "WRITE\0"
/*  1755 */ "write\0"
/*  1761 */ "Deletes the objects matching the PKCS #11 URL\0"
/*  1807 */ "DELETE\0"
/*  1814 */ "delete\0"
/*  1821 */ "Generate random data\0"
/*  1842 */ "GENERATE_RANDOM\0"
/*  1858 */ "generate-random\0"
/*  1874 */ "Generate an RSA private-public key pair\0"
/*  1914 */ "GENERATE_RSA\0"
/*  1927 */ "generate-rsa\0"
/*  1940 */ "GENERATE_DSA\0"
/*  1953 */ "generate-dsa\0"
/*  1966 */ "GENERATE_ECC\0"
/*  1979 */ "generate-ecc\0"
/*  1992 */ "Sets a label for the write operation\0"
/*  2029 */ "LABEL\0"
/*  2035 */ "label\0"
/*  2041 */ "Marks the object to be written as trusted\0"
/*  2083 */ "TRUSTED\0"
/*  2091 */ "no-trusted\0"
/*  2102 */ "no\0"
/*  2105 */ "Marks the object to be written as private\0"
/*  2147 */ "PRIVATE\0"
/*  2155 */ "no-private\0"
/*  2166 */ "Force (user) login to token\0"
/*  2194 */ "LOGIN\0"
/*  2200 */ "no-login\0"
/*  2209 */ "Force security officer login to token\0"
/*  2247 */ "SO_LOGIN\0"
/*  2256 */ "no-so-login\0"
/*  2268 */ "an alias for the 'so-login' option\0"
/*  2303 */ "admin-login\0"
/*  2315 */ "Print detailed URLs\0"
/*  2335 */ "DETAILED_URL\0"
/*  2348 */ "no-detailed-url\0"
/*  2364 */ "Provide a hex encoded secret key\0"
/*  2397 */ "SECRET_KEY\0"
/*  2408 */ "secret-key\0"
/*  2419 */ "Private key file to use\0"
/*  2443 */ "LOAD_PRIVKEY\0"
/*  2456 */ "load-privkey\0"
/*  2469 */ "Public key file to use\0"
/*  2492 */ "LOAD_PUBKEY\0"
/*  2504 */ "load-pubkey\0"
/*  2516 */ "Certificate file to use\0"
/*  2540 */ "LOAD_CERTIFICATE\0"
/*  2557 */ "load-certificate\0"
/*  2574 */ "Use PKCS #8 format for private keys\0"
/*  2610 */ "PKCS8\0"
/*  2616 */ "pkcs8\0"
/*  2622 */ "Specify the number of bits for key generate\0"
/*  2666 */ "BITS\0"
/*  2671 */ "bits\0"
/*  2676 */ "Specify the security level\0"
/*  2703 */ "SEC_PARAM\0"
/*  2713 */ "sec-param\0"
/*  2723 */ "Use DER/RAW format for input\0"
/*  2752 */ "INDER\0"
/*  2758 */ "no-inder\0"
/*  2767 */ "an alias for the 'inder' option\0"
/*  2799 */ "inraw\0"
/*  2805 */ "Use DER format for output certificates, private keys, and DH parameters\0"
/*  2877 */ "OUTDER\0"
/*  2884 */ "no-outder\0"
/*  2894 */ "an alias for the 'outder' option\0"
/*  2927 */ "outraw\0"
/*  2934 */ "Specify the PKCS #11 provider library\0"
/*  2972 */ "PROVIDER\0"
/*  2981 */ "provider\0"
/*  2990 */ "display extended usage information and exit\0"
/*  3034 */ "help\0"
/*  3039 */ "extended usage information passed thru pager\0"
/*  3084 */ "more-help\0"
/*  3094 */ "output version information and exit\0"
/*  3130 */ "version\0"
/*  3138 */ "P11TOOL\0"
/*  3146 */ "p11tool - GnuTLS PKCS #11 tool\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... [url]\n\0"
/*  3241 */ "bugs@gnutls.org\0"
/*  3257 */ "\n\0"
/*  3259 */ "Program that allows handling data from PKCS #11 smart cards and security\n"
            "modules.\n\n"
            ...
            "variable GNUTLS_PIN.\n\0"
/*  3669 */ "p11tool 3.2.12\0"
/*  3684 */ "p11tool [options] [url]\n"
...
#define LIST_ALL_DESC      (p11tool_opt_strs+1212)
/** Upper-cased name for the list-all option */
#define LIST_ALL_NAME      (p11tool_opt_strs+1250)
/** Name string for the list-all option */
#define LIST_ALL_name      (p11tool_opt_strs+1259)
...
#define LIST_ALL_CERTS_DESC      (p11tool_opt_strs+1268)
/** Upper-cased name for the list-all-certs option */
#define LIST_ALL_CERTS_NAME      (p11tool_opt_strs+1311)
/** Name string for the list-all-certs option */
#define LIST_ALL_CERTS_name      (p11tool_opt_strs+1326)
...
#define LIST_CERTS_DESC      (p11tool_opt_strs+1341)
/** Upper-cased name for the list-certs option */
#define LIST_CERTS_NAME      (p11tool_opt_strs+1399)
/** Name string for the list-certs option */
#define LIST_CERTS_name      (p11tool_opt_strs+1410)
...
#define LIST_ALL_PRIVKEYS_DESC      (p11tool_opt_strs+1421)
/** Upper-cased name for the list-all-privkeys option */
#define LIST_ALL_PRIVKEYS_NAME      (p11tool_opt_strs+1464)
/** Name string for the list-all-privkeys option */
#define LIST_ALL_PRIVKEYS_name      (p11tool_opt_strs+1482)
...
#define LIST_PRIVKEYS_DESC    (p11tool_opt_strs+1500)
#define LIST_PRIVKEYS_NAME    NULL
/** Unmodified name string for the list-privkeys option */
#define LIST_PRIVKEYS_name    (p11tool_opt_strs+1544)
...
#define LIST_KEYS_DESC    (p11tool_opt_strs+1500)
#define LIST_KEYS_NAME    NULL
/** Unmodified name string for the list-keys option */
#define LIST_KEYS_name    (p11tool_opt_strs+1558)
...
#define LIST_ALL_TRUSTED_DESC      (p11tool_opt_strs+1568)
/** Upper-cased name for the list-all-trusted option */
#define LIST_ALL_TRUSTED_NAME      (p11tool_opt_strs+1618)
/** Name string for the list-all-trusted option */
#define LIST_ALL_TRUSTED_name      (p11tool_opt_strs+1635)
...
#define INITIALIZE_DESC      (p11tool_opt_strs+1652)
/** Upper-cased name for the initialize option */
#define INITIALIZE_NAME      (p11tool_opt_strs+1681)
/** Name string for the initialize option */
#define INITIALIZE_name      (p11tool_opt_strs+1692)
...
#define WRITE_DESC      (p11tool_opt_strs+1703)
/** Upper-cased name for the write option */
#define WRITE_NAME      (p11tool_opt_strs+1749)
/** Name string for the write option */
#define WRITE_name      (p11tool_opt_strs+1755)
...
#define DELETE_DESC      (p11tool_opt_strs+1761)
/** Upper-cased name for the delete option */
#define DELETE_NAME      (p11tool_opt_strs+1807)
/** Name string for the delete option */
#define DELETE_name      (p11tool_opt_strs+1814)
...
#define GENERATE_RANDOM_DESC      (p11tool_opt_strs+1821)
/** Upper-cased name for the generate-random option */
#define GENERATE_RANDOM_NAME      (p11tool_opt_strs+1842)
/** Name string for the generate-random option */
#define GENERATE_RANDOM_name      (p11tool_opt_strs+1858)
...
#define GENERATE_RSA_DESC      (p11tool_opt_strs+1874)
/** Upper-cased name for the generate-rsa option */
#define GENERATE_RSA_NAME      (p11tool_opt_strs+1914)
/** Name string for the generate-rsa option */
#define GENERATE_RSA_name      (p11tool_opt_strs+1927)
...
#define GENERATE_DSA_DESC      (p11tool_opt_strs+1874)
/** Upper-cased name for the generate-dsa option */
#define GENERATE_DSA_NAME      (p11tool_opt_strs+1940)
/** Name string for the generate-dsa option */
#define GENERATE_DSA_name      (p11tool_opt_strs+1953)
...
#define GENERATE_ECC_DESC      (p11tool_opt_strs+1874)
/** Upper-cased name for the generate-ecc option */
#define GENERATE_ECC_NAME      (p11tool_opt_strs+1966)
/** Name string for the generate-ecc option */
#define GENERATE_ECC_name      (p11tool_opt_strs+1979)
...
#define LABEL_DESC      (p11tool_opt_strs+1992)
/** Upper-cased name for the label option */
#define LABEL_NAME      (p11tool_opt_strs+2029)
/** Name string for the label option */
#define LABEL_name      (p11tool_opt_strs+2035)
...
#define TRUSTED_DESC      (p11tool_opt_strs+2041)
/** Upper-cased name for the trusted option */
#define TRUSTED_NAME      (p11tool_opt_strs+2083)
/** disablement name for the trusted option */
#define NOT_TRUSTED_name  (p11tool_opt_strs+2091)
/** disablement prefix for the trusted option */
#define NOT_TRUSTED_PFX   (p11tool_opt_strs+2102)
...
#define PRIVATE_DESC      (p11tool_opt_strs+2105)
/** Upper-cased name for the private option */
#define PRIVATE_NAME      (p11tool_opt_strs+2147)
/** disablement name for the private option */
#define NOT_PRIVATE_name  (p11tool_opt_strs+2155)
/** disablement prefix for the private option */
#define NOT_PRIVATE_PFX   (p11tool_opt_strs+2102)
...
#define LOGIN_DESC      (p11tool_opt_strs+2166)
/** Upper-cased name for the login option */
#define LOGIN_NAME      (p11tool_opt_strs+2194)
/** disablement name for the login option */
#define NOT_LOGIN_name  (p11tool_opt_strs+2200)
/** disablement prefix for the login option */
#define NOT_LOGIN_PFX   (p11tool_opt_strs+2102)
...
#define SO_LOGIN_DESC      (p11tool_opt_strs+2209)
/** Upper-cased name for the so-login option */
#define SO_LOGIN_NAME      (p11tool_opt_strs+2247)
/** disablement name for the so-login option */
#define NOT_SO_LOGIN_name  (p11tool_opt_strs+2256)
/** disablement prefix for the so-login option */
#define NOT_SO_LOGIN_PFX   (p11tool_opt_strs+2102)
...
#define ADMIN_LOGIN_DESC    (p11tool_opt_strs+2268)
#define ADMIN_LOGIN_NAME    NULL
/** Unmodified name string for the admin-login option */
#define ADMIN_LOGIN_name    (p11tool_opt_strs+2303)
...
#define DETAILED_URL_DESC      (p11tool_opt_strs+2315)
/** Upper-cased name for the detailed-url option */
#define DETAILED_URL_NAME      (p11tool_opt_strs+2335)
/** disablement name for the detailed-url option */
#define NOT_DETAILED_URL_name  (p11tool_opt_strs+2348)
/** disablement prefix for the detailed-url option */
#define NOT_DETAILED_URL_PFX   (p11tool_opt_strs+2102)
...
#define SECRET_KEY_DESC      (p11tool_opt_strs+2364)
/** Upper-cased name for the secret-key option */
#define SECRET_KEY_NAME      (p11tool_opt_strs+2397)
/** Name string for the secret-key option */
#define SECRET_KEY_name      (p11tool_opt_strs+2408)
...
#define LOAD_PRIVKEY_DESC      (p11tool_opt_strs+2419)
/** Upper-cased name for the load-privkey option */
#define LOAD_PRIVKEY_NAME      (p11tool_opt_strs+2443)
/** Name string for the load-privkey option */
#define LOAD_PRIVKEY_name      (p11tool_opt_strs+2456)
...
#define LOAD_PUBKEY_DESC      (p11tool_opt_strs+2469)
/** Upper-cased name for the load-pubkey option */
#define LOAD_PUBKEY_NAME      (p11tool_opt_strs+2492)
/** Name string for the load-pubkey option */
#define LOAD_PUBKEY_name      (p11tool_opt_strs+2504)
...
#define LOAD_CERTIFICATE_DESC      (p11tool_opt_strs+2516)
/** Upper-cased name for the load-certificate option */
#define LOAD_CERTIFICATE_NAME      (p11tool_opt_strs+2540)
/** Name string for the load-certificate option */
#define LOAD_CERTIFICATE_name      (p11tool_opt_strs+2557)
...
#define PKCS8_DESC      (p11tool_opt_strs+2574)
/** Upper-cased name for the pkcs8 option */
#define PKCS8_NAME      (p11tool_opt_strs+2610)
/** Name string for the pkcs8 option */
#define PKCS8_name      (p11tool_opt_strs+2616)
...
#define BITS_DESC      (p11tool_opt_strs+2622)
/** Upper-cased name for the bits option */
#define BITS_NAME      (p11tool_opt_strs+2666)
/** Name string for the bits option */
#define BITS_name      (p11tool_opt_strs+2671)
...
#define SEC_PARAM_DESC      (p11tool_opt_strs+2676)
/** Upper-cased name for the sec-param option */
#define SEC_PARAM_NAME      (p11tool_opt_strs+2703)
/** Name string for the sec-param option */
#define SEC_PARAM_name      (p11tool_opt_strs+2713)
...
#define INDER_DESC      (p11tool_opt_strs+2723)
/** Upper-cased name for the inder option */
#define INDER_NAME      (p11tool_opt_strs+2752)
/** disablement name for the inder option */
#define NOT_INDER_name  (p11tool_opt_strs+2758)
/** disablement prefix for the inder option */
#define NOT_INDER_PFX   (p11tool_opt_strs+2102)
...
#define INRAW_DESC    (p11tool_opt_strs+2767)
#define INRAW_NAME    NULL
/** Unmodified name string for the inraw option */
#define INRAW_name    (p11tool_opt_strs+2799)
...
#define OUTDER_DESC      (p11tool_opt_strs+2805)
/** Upper-cased name for the outder option */
#define OUTDER_NAME      (p11tool_opt_strs+2877)
/** disablement name for the outder option */
#define NOT_OUTDER_name  (p11tool_opt_strs+2884)
/** disablement prefix for the outder option */
#define NOT_OUTDER_PFX   (p11tool_opt_strs+2102)
...
#define OUTRAW_DESC    (p11tool_opt_strs+2894)
#define OUTRAW_NAME    NULL
/** Unmodified name string for the outraw option */
#define OUTRAW_name    (p11tool_opt_strs+2927)
...
#define PROVIDER_DESC      (p11tool_opt_strs+2934)
/** Upper-cased name for the provider option */
#define PROVIDER_NAME      (p11tool_opt_strs+2972)
/** Name string for the provider option */
#define PROVIDER_name      (p11tool_opt_strs+2981)
 ...
 */
#define HELP_DESC       (p11tool_opt_strs+2990)
#define HELP_name       (p11tool_opt_strs+3034)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (p11tool_opt_strs+3039)
#define MORE_HELP_name  (p11tool_opt_strs+3084)
...
#endif
#define VER_DESC        (p11tool_opt_strs+3094)
#define VER_name        (p11tool_opt_strs+3130)
/**
...
static tOptProc
    doOptAdmin_Login,      doOptDebug,            doOptInraw,
    doOptList_Keys,        doOptList_Privkeys,    doOptLoad_Certificate,
    doOptLoad_Privkey,     doOptLoad_Pubkey,      doOptOutraw,
    doOptProvider,         doUsageOpt;
...
static tOptDesc optDesc[OPTION_CT] = {
  ...
  {  /* entry idx, value */ 6, VALUE_OPT_LIST_ALL,
     /* equiv idx, value */ 6, VALUE_OPT_LIST_ALL,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 7, VALUE_OPT_LIST_ALL_CERTS,
     /* equiv idx, value */ 7, VALUE_OPT_LIST_ALL_CERTS,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 8, VALUE_OPT_LIST_CERTS,
     /* equiv idx, value */ 8, VALUE_OPT_LIST_CERTS,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 9, VALUE_OPT_LIST_ALL_PRIVKEYS,
     /* equiv idx, value */ 9, VALUE_OPT_LIST_ALL_PRIVKEYS,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 10, VALUE_OPT_LIST_PRIVKEYS,
     /* equiv idx, value */ 10, VALUE_OPT_LIST_PRIVKEYS,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 11, VALUE_OPT_LIST_KEYS,
     /* equiv idx, value */ 11, VALUE_OPT_LIST_KEYS,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 12, VALUE_OPT_LIST_ALL_TRUSTED,
     /* equiv idx, value */ 12, VALUE_OPT_LIST_ALL_TRUSTED,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 13, VALUE_OPT_INITIALIZE,
     /* equiv idx, value */ 13, VALUE_OPT_INITIALIZE,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 20, VALUE_OPT_LABEL,
     /* equiv idx, value */ 20, VALUE_OPT_LABEL,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 21, VALUE_OPT_TRUSTED,
     /* equiv idx, value */ 21, VALUE_OPT_TRUSTED,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 22, VALUE_OPT_PRIVATE,
     /* equiv idx, value */ 22, VALUE_OPT_PRIVATE,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 23, VALUE_OPT_LOGIN,
     /* equiv idx, value */ 23, VALUE_OPT_LOGIN,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 24, VALUE_OPT_SO_LOGIN,
     /* equiv idx, value */ 24, VALUE_OPT_SO_LOGIN,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 25, VALUE_OPT_ADMIN_LOGIN,
     /* equiv idx, value */ 25, VALUE_OPT_ADMIN_LOGIN,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 26, VALUE_OPT_DETAILED_URL,
     /* equiv idx, value */ 26, VALUE_OPT_DETAILED_URL,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 27, VALUE_OPT_SECRET_KEY,
     /* equiv idx, value */ 27, VALUE_OPT_SECRET_KEY,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 28, VALUE_OPT_LOAD_PRIVKEY,
     /* equiv idx, value */ 28, VALUE_OPT_LOAD_PRIVKEY,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 29, VALUE_OPT_LOAD_PUBKEY,
     /* equiv idx, value */ 29, VALUE_OPT_LOAD_PUBKEY,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 30, VALUE_OPT_LOAD_CERTIFICATE,
     /* equiv idx, value */ 30, VALUE_OPT_LOAD_CERTIFICATE,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 31, VALUE_OPT_PKCS8,
     /* equiv idx, value */ 31, VALUE_OPT_PKCS8,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 32, VALUE_OPT_BITS,
     /* equiv idx, value */ 32, VALUE_OPT_BITS,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 33, VALUE_OPT_SEC_PARAM,
     /* equiv idx, value */ 33, VALUE_OPT_SEC_PARAM,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 34, VALUE_OPT_INDER,
     /* equiv idx, value */ 34, VALUE_OPT_INDER,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 35, VALUE_OPT_INRAW,
     /* equiv idx, value */ 35, VALUE_OPT_INRAW,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 36, VALUE_OPT_OUTDER,
     /* equiv idx, value */ 36, VALUE_OPT_OUTDER,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
  ...
  {  /* entry idx, value */ 37, VALUE_OPT_OUTRAW,
     /* equiv idx, value */ 37, VALUE_OPT_OUTRAW,
     /* equivalenced to  */ NO_EQUIVALENT,
     /* min, max, act ct */ 0, 1, 0,
...
#define zPROGNAME       (p11tool_opt_strs+3138)
/** Reference to the title line for p11tool usage. */
#define zUsageTitle     (p11tool_opt_strs+3146)
...
#define zBugsAddr       (p11tool_opt_strs+3241)
/** Clarification/explanation of what p11tool does. */
#define zExplain        (p11tool_opt_strs+3257)
/** Extra detail explaining what p11tool does. */
#define zDetail         (p11tool_opt_strs+3259)
/** The full version string for p11tool. */
#define zFullVersion    (p11tool_opt_strs+3669)
...
#define p11tool_short_usage (p11tool_opt_strs+3684)
...
modules.\n\n"));
  puts(_("To use PKCS #11 tokens with gnutls the configuration file\n\
/etc/gnutls/pkcs11.conf has to exist and contain a number of lines of the\n\
form 'load=/usr/lib/opensc-pkcs11.so'.  Alternatively the p11-kit\n\
configuration files have to be setup.\n\n"));
  puts(_("To provide the PIN for all the operations below use the environment\n\
variable GNUTLS_PIN.\n"));
