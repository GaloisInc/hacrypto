...
typedef enum {
    ...
    INDEX_OPT_LIST                    = 38,
    INDEX_OPT_NOTICKET                = 39,
    INDEX_OPT_SRTP_PROFILES           = 40,
    INDEX_OPT_ALPN                    = 41,
    INDEX_OPT_HEARTBEAT               = 42,
    INDEX_OPT_RECORDSIZE              = 43,
    INDEX_OPT_DISABLE_SNI             = 44,
    INDEX_OPT_DISABLE_EXTENSIONS      = 45,
    INDEX_OPT_INLINE_COMMANDS         = 46,
    INDEX_OPT_INLINE_COMMANDS_PREFIX  = 47,
...
#define OPTION_CT    51
/** gnutls-cli version */
#define GNUTLS_CLI_VERSION       "3.2.12"
/** Full gnutls-cli version text */
#define GNUTLS_CLI_FULL_VERSION  "gnutls-cli 3.2.12"
...
#define VALUE_OPT_BENCHMARK_SOFT_CIPHERS 0x101C
#define VALUE_OPT_BENCHMARK_TLS_KX 0x101D
#define VALUE_OPT_BENCHMARK_TLS_CIPHERS 0x101E
#define VALUE_OPT_LIST           'l'
#define VALUE_OPT_NOTICKET       0x101F
#define VALUE_OPT_SRTP_PROFILES  0x1020
#define VALUE_OPT_ALPN           0x1021
#define VALUE_OPT_HEARTBEAT      'b'
#define VALUE_OPT_RECORDSIZE     0x1022

#define OPT_VALUE_RECORDSIZE     (DESC(RECORDSIZE).optArg.argInt)
#define VALUE_OPT_DISABLE_SNI    0x1023
#define VALUE_OPT_DISABLE_EXTENSIONS 0x1024
#define VALUE_OPT_INLINE_COMMANDS 0x1025
#define VALUE_OPT_INLINE_COMMANDS_PREFIX 0x1026
